...
export default class SearchBar extends PureComponent<SearchBarProps, SearchBarState> {
  ...
  componentDidUpdate(prevProps: SearchBarProps) {
    const { cancelText, showCancel, locale = localeZhCn } = this.props;
  ...
  renderCancel() {
    const { prefixCls, cancelText, locale = localeZhCn } = this.props;
      ...
      <div className={cls}>
        ...
        >
          <div className={`${prefixCls}__content`}>
            {XIcon.Search({size:"sm",className:`${prefixCls}__icon`})}
            <div className={`${prefixCls}__mock`}>
              <InputBase
                className={`${prefixCls}__input`}
                type="search"
                placeholder={placeholder || (locale && locale.searchText)}
                value={value}
                maxLength={maxLength}
                onFocus={() => {
                  this.onFocus();
          ...
          {this.props.showCancel && this.renderCancel()}
        </form>
      </div>
    );
  }
