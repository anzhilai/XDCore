...
import Drag, { DragEvent, DragState } from '../../layout/drag/Drag';
import Tooltip from '../../display/tooltip/Tooltip';
import ensureValuePrecision from './ensureValuePrecision';
...
export default class Slider extends PureComponent<SliderProps, SliderStates> {
  ...
  renderMarkInfo = () => {
    ...
    const isEmptyMarks = !XTools.isObject(marks) || JSON.stringify(marks) === '{}';
