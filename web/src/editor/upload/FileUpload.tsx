...
export interface FileUploadProps extends PropsType {
  prefixCls?: string;
  className?: string;
}
...
export default class FileUpload extends PureComponent<FileUploadProps, {}> {
  ...
  render() {
    ...
    // @ts-ignore
    const content = cloneElement(children, {onClick: this.handleClick, className: classNames(children.props.className, 'needsclick'),
    });
