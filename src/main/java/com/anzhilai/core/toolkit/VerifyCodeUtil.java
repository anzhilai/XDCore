...
public class VerifyCodeUtil {
    ...
    public static String FONT_NAME = null;//默认字体
    //    public static String FONT_NAME = "Algerian";
    private static Random random = new Random();

    public static void main(String[] args) throws IOException {
        File dir = new File("C:\\Users\\tangbin\\Desktop");
        int w = 200, h = 80;
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        for (int i = 0; i < verifySize; i++) {
            ...
            g2.drawChars(chars, i, 1, ((w - 10) / verifySize) * i + 5, h / 2 + fontSize / 2 - h / 6);
        }
        g2.dispose();
    ...
    public static String GetPublicKey() {
        if (StrUtil.isEmpty(publicKey)) {
            publicKey = CommonConfig.GetCustomConfigValue(CommonConfig.F_verifyCodeRsaPublicKey);
            if (StrUtil.isEmpty(publicKey)) {
                publicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCZVRhYExG0Zz14LMT61hKpw22Z1lLfC1l2BYdEZUyBREqCqS/2dQnnVIeR4eypwcmcoky6WVeaVh5oPbdU+KC5IqexkYuoyETLoIB07IFl+SJG1r9G9RrV6DTVNttvWt0oxW9jnaIv6spWp3dY5hIUSkUjqOaG9RqLkGvnGKdXLQIDAQAB";
            }
        }
        return publicKey;
    }
    ...
    public static String DecryptVerifyCode(String key) throws Exception {
        String[] strs = RSAUtil.decrypt(key, GetPrivateKey()).split("_");//私钥解密;
